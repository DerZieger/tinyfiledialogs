This is not the officvial tiny file dialogs repo.  
I wanted a up to date version of the [sourceforge](http://tinyfiledialogs.sourceforge.net) version on github.  
Additionally I added a cmake file, which also enables fetchcontent using cmake.
